...
class CreateUserJabatanChangeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_jabatan_request', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('user_jabatan_change');
    }
}
