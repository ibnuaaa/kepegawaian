                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <a class="side-menu__item" data-bs-toggle="slide" href="{!! url('/indikator_skp'); !!}"><i class="side-menu__icon fe fe-file-text"></i><span class="side-menu__label">Indikator SKP</span></a>
                        </li>
