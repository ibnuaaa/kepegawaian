    ...
    <div class="header ">
        ...
        <div class="">
            <div class="brand inline  m-l-10 text-center">
                <img src="/assets/img/logo-rspon.png?2" alt="logo" data-src="/assets/img/logo-rspon.png?2" data-src-retina="/assets/img/logo-rspon.png?2" height="50" class="d-none d-lg-block">
            </div>
        </div>
