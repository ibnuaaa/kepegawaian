...
<div class="page-header">
    <h1 class="page-title">Pelatihan
        <a href="/pelatihan/new" class="btn btn-primary btn-sm">
        ...
        <tr>
            ...
            <td class="v-align-middle">
                <div class="btn-group btn-group-sm">
                    <a href="{{ url('/pelatihan/'.$item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                    <a href="{{ url('/pelatihan/edit/'.$item->id) }}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
...
@section('script')
@include('app.pelatihan.home.scripts.index')
@endsection
