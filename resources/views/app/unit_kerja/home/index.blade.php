...
<div class="page-header">
    <h1 class="page-title">Unit Kerja <a href="/unit_kerja/new" class="btn btn-primary btn-sm">
      (+) Buat Unit Kerja
    </a></h1>
    <div>
        <ol class="breadcrumb">
                ...
                <tr>
                    ...
                    <td class="v-align-middle">
                        <div class="btn-group btn-group-sm">
                            <a href="{{ url('/unit_kerja/'.$item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                            <a href="{{ url('/unit_kerja/edit/'.$item->id) }}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
...
@section('script')
    @include('app.unit_kerja.home.scripts.index')
@endsection
