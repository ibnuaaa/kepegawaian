            ...
            <div class="card-body">
                <form id="editUserForm">
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9">
                            <input name="code" value="" class="form-control" type="text" placeholder="" required>
                        </div>
                    </div>
                    <div class=" row mb-4">
                        <label class="col-md-3 form-label">Nama Mata Anggaran</label>
                        <div class="col-md-9">
                    ...
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9 pt-2">
                            {{ !empty($parent_mata_anggaran->name) ? $parent_mata_anggaran->name : '< Kosong >' }}
                        </div>
                    </div>
...
@include('app.mata_anggaran.new.scripts.form')
@endsection
