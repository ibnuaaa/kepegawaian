                ...
                <tr>
                    ...
                    <td class="v-align-middle">
                        <div class="btn-group btn-group-sm">
                            <a href="{{ url('/pendidikan/'.$item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                            <a href="{{ url('/pendidikan/edit/'.$item->id) }}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
...
@section('script')
    @include('app.pendidikan.home.scripts.index')
@endsection
