<div class="list-group list-group-transparent mb-0 mail-inbox pb-3">
    ...
    <a href="/complaint/inbox" class="list-group-item d-flex align-items-center active mx-4">
        <span class="icons"><i class="ri-mail-line"></i></span> Inbox
        <span class="ms-auto badge bg-secondary bradius hide">14</span>
    </a>
    <a href="/complaint/drafts" class="list-group-item d-flex align-items-center mx-4">
        <span class="icons"><i class="ri-mail-open-line"></i></span> Drafts
    </a>
    <a href="/complaint/starred" class="list-group-item d-flex align-items-center mx-4">
        <span class="icons"><i class="ri-star-line"></i></span> Starred
    </a>
    <a href="/complaint/tags" class="list-group-item d-flex align-items-center mx-4">
        <span class="icons"><i class="ri-price-tag-3-line"></i></span> Tags
    </a>
    <a href="/complaint/sent" class="list-group-item d-flex align-items-center mx-4">
        <span class="icons"><i class="ri-mail-send-line"></i></span> Sent Mail
    </a>
    <a href="/complaint/trash" class="list-group-item d-flex align-items-center mx-4">
