            ...
            <div class="card-body">
                <form autocomplete="off" id="editDocumentUnitForm">
                    ...
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9">
                            <input name="revisi_ke" value="{{ $data->revisi_ke }}" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class=" row mb-4">
                    ...
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9 pt-2">
                          <input type="file" onchange="prepareUpload(this, 'document_unit', '{{ $data->id }}', false, ['pdf']);" multiple>
