...
<div class="page-header">
    <h1 class="page-title">IKI
        <a href="/e_kinerja_iki/new" class="btn btn-primary btn-sm">
        ...
        <tr>
            ...
            <td class="v-align-middle">
                <div class="btn-group btn-group-sm">
                    <a href="{{ url('/e_kinerja_iki/'.$item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                    <a href="{{ url('/e_kinerja_iki/edit/'.$item->id) }}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
...
@section('script')
@include('app.e_kinerja_iki.home.scripts.index')
@endsection
