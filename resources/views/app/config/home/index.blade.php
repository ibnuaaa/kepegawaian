                ...
                <div class="row">
                    <div class="col-sm-4">
                        <ul class="navbar-nav d-flex flex-row">
                            <li class="nav-item">
                                <a href="{{ url('/config/new') }}"><i class="fas fa-plus"></i> Create</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-4">
                        <ul class="navbar-nav d-flex">
                            <li class="nav-item">
                                <a href="#" onClick="return clearTransaction();"><i class="fas fa-trash"></i>
                                    Clear Transaction
                                </a>
                            </li>
                        </ul>
    ...
    <div class="card card-white">
        ...
        <div class="card-body">
            ...
            <tr>
                ...
                <td class="v-align-middle">
                    <div class="btn-group">
                        <a href="{{ url('/config/edit/'.$item->id) }}" class="btn btn-success btn-xs">Edit</a>
