                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <ul class="navbar-nav d-flex">
                                <li class="nav-item">
                                    <a href="{{ url('/user/new') }}"><i class="fas fa-plus"></i>
                                        Create
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 m-t-10 sm-m-t-10">
                                <button onClick="return false;" id="deleteAction" class="btn btn-block btn-danger btn-cons m-b-10"><i class="fas fa-trash"></i> Yes Delete</button>
                            </div>
                        </div>
                    </div>
                </div>
