...
<div class="page-header">
    <h1 class="page-title">JabatanFungsional
        <a href="/jabatan_fungsional/new" class="btn btn-primary btn-sm">
            <i class="fa fa-plus"></i>
            Buat JabatanFungsional
        </a>
    </h1>
    <div>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">JabatanFungsional</li>
        </ol>
    </div>
</div>
<!-- PAGE-HEADER END -->
        ...
        <tr>
            ...
            <td class="v-align-middle">
                <div class="btn-group btn-group-sm">
                    <a href="{{ url('/jabatan_fungsional/'.$item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                    <a href="{{ url('/jabatan_fungsional/edit/'.$item->id) }}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
...
@section('script')
@include('app.jabatan_fungsional.home.scripts.index')
@endsection
