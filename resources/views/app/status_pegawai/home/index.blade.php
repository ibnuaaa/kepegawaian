...
<div class="page-header">
    <h1 class="page-title">Status Pegawai
        <a href="/status_pegawai/new" class="btn btn-primary btn-sm">
    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Status Pegawai</li>
        </ol>
    </div>
</div>
<!-- PAGE-HEADER END -->
        ...
        <tr>
            ...
            <td class="v-align-middle">
                <div class="btn-group btn-group-sm">
                    <a href="{{ url('/status_pegawai/'.$item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                    <a href="{{ url('/status_pegawai/edit/'.$item->id) }}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
...
@section('script')
@include('app.status_pegawai.home.scripts.index')
@endsection
