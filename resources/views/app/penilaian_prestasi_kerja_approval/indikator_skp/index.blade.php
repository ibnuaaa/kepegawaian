...
<div class="page-header">
    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="/penilaian_prestasi_kerja_approval">Penilaian SKP</a></li>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
        @component('components.table', ['data' => $data, 'props' => ['penilaian_prestasi_kerja_approval_id' => $penilaian_prestasi_kerja_approval_id]])
            ...
            <td class="v-align-middle ">
                ...
                <?php  foreach($item->indikator_kinerja->indikator_kinerja_child as $key => $val) : ?>
                    <tr>
                          ...
                          <b class="text-blue">
                            ...
                            <table class="table table-bordered table-sm bg-white">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href="/indikator_skp/edit/{{ $val2->id }}/{{$props['penilaian_prestasi_kerja_approval_id']}}" class=" btn btn-primary btn-sm">
                                ...
                                <tr>
                                    <td class="text-left" colspan="2">
                                        <a href="{{ url('/indikator_skp/new/kegiatan/'.$val->id.'/'.$props['penilaian_prestasi_kerja_approval_id']) }}" class="btn btn-success btn-sm">
                        ...
                        <td>
                          <a href="/indikator_skp/edit/{{ $val->id }}/{{$props['penilaian_prestasi_kerja_approval_id']}}" class=" btn btn-primary btn-sm">
                              <i class="fa fa-edit"></i>
                          </a>
                ...
                <tr>
                    <td colspan="3" class="text-left">
                        <a href="{{ url('/indikator_skp/new/kegiatan/'.$item->indikator_kinerja->id.'/'.$props['penilaian_prestasi_kerja_approval_id']) }}" class="btn btn-success btn-sm">
                            <i class="fa fa-plus"></i>
                            Tambah Kegiatan
                        </a>
                        <a href="{{ url('/indikator_skp/new/program/'.$item->indikator_kinerja->id.'/'.$props['penilaian_prestasi_kerja_approval_id']) }}" class="btn btn-primary btn-sm">
                            <i class="fa fa-plus"></i>
                            Tambah Program
                        </a>
                    </td>
...
@section('script')
@include('app.penilaian_prestasi_kerja_approval.indikator_skp.scripts.index')
@endsection
