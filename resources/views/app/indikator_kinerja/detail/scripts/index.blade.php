...
function resetPassword() {
    ...
    axios.post('/indikator_kinerja/reset_password', {
...
function inactiveIndikatorKinerja(status) {
...
function savePLT() {
    ...
    if (g_id > 0) {
    axios.put('/indikator_kinerja_coupon/' + g_id, {
    ...
    axios.post('/indikator_kinerja_coupon', {
...
function deletePLT(id) {
    if (confirm('Are you sure ?')) {
        showLoading()
    axios.delete('/indikator_kinerja_coupon/' + id).then((response) => {
            window.location.reload()
        }).catch((error) => {
            hideLoading()
            if (Boolean(error) && Boolean(error.response) && Boolean(error.response.data) && Boolean(error.response.data.exception) && Boolean(error.response.data.exception.message)) {
...
function editPLT(id) {
    ...
    showLoading()
axios.get('/indikator_kinerja_coupon/id/' + id + '/set/first').then((response) => {
