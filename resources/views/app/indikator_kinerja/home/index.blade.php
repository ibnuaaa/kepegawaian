...
<div class="page-header">
    <h1 class="page-title">Indikator Kinerja <a href="/indikator_kinerja/new" class="btn btn-primary btn-sm">
                ...
                <tr>
                    ...
                    <td class="v-align-middle">
                        <div class="btn-group btn-group-sm">
                            <a href="{{ url('/indikator_kinerja/'.$item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                            <a href="{{ url('/indikator_kinerja/edit/'.$item->id) }}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
...
@section('script')
    @include('app.indikator_kinerja.home.scripts.index')
@endsection
