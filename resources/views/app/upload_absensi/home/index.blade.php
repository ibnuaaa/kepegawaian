...
<div class="page-header">
    <h1 class="page-title">Upload Absensi
        <a href="/upload_absensi/new" class="btn btn-primary btn-sm">
    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Upload Absensi</li>
        </ol>
    </div>
</div>
<!-- PAGE-HEADER END -->
        ...
        <tr>
            ...
            <td class="v-align-middle">
                <div class="btn-group btn-group-sm">
                    <a href="{{ url('/upload_absensi/'.$item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
                    <a href="{{ url('/upload_absensi/edit/'.$item->id) }}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
...
@section('script')
@include('app.upload_absensi.home.scripts.index')
@endsection
