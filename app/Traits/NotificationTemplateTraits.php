...
trait NotificationTemplateTraits
{
    ...
    {
        $CurrentPosition = Position::where('id', Auth::user()->active_position_id)->first();
        ...
        $text = str_replace('{{ position_name }}', ((!empty($CurrentPosition->shortname)) ? $CurrentPosition->shortname : ''), $text);
