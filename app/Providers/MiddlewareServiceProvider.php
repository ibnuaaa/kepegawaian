...
class MiddlewareServiceProvider extends ServiceProvider
{
    ...
    protected $routeMiddleware = [
        ...
        'Complaint.Insert' => \App\Http\Middleware\Complaint\Insert::class,
        'Complaint.Update' => \App\Http\Middleware\Complaint\Update::class,
        'Complaint.Delete' => \App\Http\Middleware\Complaint\Delete::class,

        'ComplaintTo.Insert' => \App\Http\Middleware\ComplaintTo\Insert::class,
        ...
        'Kampus.Insert' => \App\Http\Middleware\Kampus\Insert::class,
        'Kampus.Update' => \App\Http\Middleware\Kampus\Update::class,
        'Kampus.Delete' => \App\Http\Middleware\Kampus\Delete::class,
