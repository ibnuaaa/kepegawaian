...
class UserJabatanRequestController extends Controller
{
    use Browse;
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->UserJabatanRequest->save();

        Json::set('data', $this->SyncData($request, $Model->UserJabatanRequest->id));
    ...
    {
        $Model = $request->Payload->all()['Model'];
        $Model->UserJabatanRequest->delete();
        return response()->json(Json::get(), 202);
    }
