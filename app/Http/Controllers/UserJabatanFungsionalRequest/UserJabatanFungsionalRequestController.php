...
class UserJabatanFungsionalRequestController extends Controller
{
    use Browse;
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->UserJabatanFungsionalRequest->save();

        Json::set('data', $this->SyncData($request, $Model->UserJabatanFungsionalRequest->id));
    ...
    {
        $Model = $request->Payload->all()['Model'];
        $Model->UserJabatanFungsionalRequest->delete();
        return response()->json(Json::get(), 202);
    }
