...
class UserPelatihanRequestController extends Controller
{
    use Browse;
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->UserPelatihanRequest->save();

        Json::set('data', $this->SyncData($request, $Model->UserPelatihanRequest->id));
    ...
    {
        $Model = $request->Payload->all()['Model'];
        $Model->UserPelatihanRequest->delete();
        return response()->json(Json::get(), 202);
    }
