...
class UserKeluargaRequestController extends Controller
{
    use Browse;
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->UserKeluargaRequest->save();

        Json::set('data', $this->SyncData($request, $Model->UserKeluargaRequest->id));
    ...
    {
        $Model = $request->Payload->all()['Model'];
        $Model->UserKeluargaRequest->delete();
        return response()->json(Json::get(), 202);
    }
