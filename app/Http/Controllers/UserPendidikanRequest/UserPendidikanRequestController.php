...
class UserPendidikanRequestController extends Controller
{
    use Browse;
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->UserPendidikanRequest->save();

        Json::set('data', $this->SyncData($request, $Model->UserPendidikanRequest->id));
    ...
    {
        $Model = $request->Payload->all()['Model'];
        $Model->UserPendidikanRequest->delete();
        return response()->json(Json::get(), 202);
    }
