...
class PenilaianIkuController extends Controller
{
    use Browse;
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->PenilaianIku->save();

        Json::set('data', $this->SyncData($request, $Model->PenilaianIku->id));
