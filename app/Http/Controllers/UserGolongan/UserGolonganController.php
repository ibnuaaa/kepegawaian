...
class UserGolonganController extends Controller
{
    use Browse;
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->UserGolongan->save();

        Json::set('data', $this->SyncData($request, $Model->UserGolongan->id));
