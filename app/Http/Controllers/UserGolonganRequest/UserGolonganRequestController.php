...
class UserGolonganRequestController extends Controller
{
    use Browse;
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->UserGolonganRequest->save();

        Json::set('data', $this->SyncData($request, $Model->UserGolonganRequest->id));
    ...
    {
        $Model = $request->Payload->all()['Model'];
        $Model->UserGolonganRequest->delete();
        return response()->json(Json::get(), 202);
    }
