...
namespace App\Http\Controllers\ApprovalPenilaianSdm;

use App\Models\ApprovalPenilaianSdm;

use App\Traits\Browse;
use App\Traits\ApprovalPenilaianSdm\ApprovalPenilaianSdmCollection;
...
class ApprovalPenilaianSdmBrowseController extends Controller
{
    use Browse, PendidikanCollection {
        ApprovalPenilaianSdmCollection::__construct as private __PendidikanCollectionConstruct;
    }
    ...
    public function __construct(Request $request)
    {
        ...
        $this->__ApprovalPenilaianSdmCollectionConstruct();
    }
