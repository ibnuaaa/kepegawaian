...
class UserKeluargaController extends Controller
{
    use Browse;
    ...
    public function Insert(Request $request)
    {
        ...
        $Model->UserKeluarga->save();

        Json::set('data', $this->SyncData($request, $Model->UserKeluarga->id));
